...
function loadJitsiConfig() {
    fetch('/api/config')
        ...
        .then(data => {
            ...
            document.getElementById('jitsi-server-url').value = config.server_url || 'http://localhost';
...
function loadMatrixConfig() {
    fetch('/api/config')
        ...
        .then(data => {
            ...
            document.getElementById('matrix-homeserver-url').value = config.homeserver_url || 'http://localhost:8008';
...
function loadEspoCRMConfig() {
    fetch('/api/config')
        ...
        .then(data => {
            ...
            document.getElementById('espocrm-api-url').value = config.api_url || 'http://localhost/api/v1';
