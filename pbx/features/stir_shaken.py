...
class STIRSHAKENManager:
    ...
    def __init__(self, config: dict = None):
        ...
        self.logger.info(f"STIR/SHAKEN initialized (signing: {self.enable_signing}, verification: {self.enable_verification})")
    ...
    def create_passport(
        ...
        try:
            ...
            self.logger.debug(f"Created PASSporT for {originating_tn} -> {destination_tn} (attest: {attestation.value})")
            return passport
    ...
    def verify_identity_header(self, identity_header: str) -> Tuple[VerificationStatus, Optional[dict]]:
        """
...
def add_stir_shaken_to_invite(sip_message, stir_shaken_manager: STIRSHAKENManager,
    ...
    identity = stir_shaken_manager.create_identity_header(
        from_number,
        to_number,
        attestation
    )
...
def verify_stir_shaken_invite(sip_message, stir_shaken_manager: STIRSHAKENManager) -> Tuple[VerificationStatus, Optional[dict]]:
    """
