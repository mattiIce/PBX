...
class DataResidencyControls:
    ...
    def validate_storage_operation(self, category: str, target_region: str,
        ...
        if user_region in ['eu-west', 'eu-central', 'uk']:
            if target_region not in ['eu-west', 'eu-central', 'uk']:
                ...
                return {
                    'allowed': False,
                    'reason': 'EU data cannot be stored outside EU (GDPR)'
                }
    ...
    def transfer_data_between_regions(self, data_id: str, category: str,
