...
class RecordingAnnouncements:
    ...
    def __init__(self, config=None, database=None):
        ...
        self.announcement_type = announcement_config.get('type', 'both')  # 'caller', 'callee', 'both'
        self.audio_path = announcement_config.get('audio_path', 'audio/recording_announcement.wav')
        self.announcement_text = announcement_config.get('text', 
    ...
    def get_state_requirements(self, state: str) -> Dict:
        ...
        one_party_states = ['AL', 'AK', 'AZ', 'AR', 'CO', 'DC', 'GA', 'HI', 'ID', 'IN', 
                           'IA', 'KS', 'KY', 'LA', 'ME', 'MI', 'MN', 'MS', 'MO', 'NE',
                           'NV', 'NJ', 'NM', 'NY', 'NC', 'ND', 'OH', 'OK', 'OR', 'RI',
    ...
    def get_statistics(self) -> Dict:
        ...
        acceptance_rate = (self.consent_accepted / total_consent_requests * 100) if total_consent_requests > 0 else 0
