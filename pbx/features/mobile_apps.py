...
class MobileDevice:
    ...
    def __init__(self, device_id: str, platform: MobilePlatform, 
                 user_id: str, push_token: str = None):
...
class MobileAppFramework:
    ...
    def register_device(self, device_id: str, platform: str, user_id: str,
    ...
    def get_statistics(self) -> Dict:
        ...
        active_count = sum(
            ...
            if (now - d.last_active).total_seconds() < 86400
        )
