...
"""
        ...
        # Zultys ZIP 37G template (advanced SIP phone with INI format)
        # NOTE: ZIP 37G uses config.bin (TAR archive with INI files), not flat .cfg
        # This template provides flat .cfg format for basic compatibility
        # For full ZIP 37G support, config.bin TAR archive generation is needed
        zultys_zip37g_template = """; Zultys ZIP 37G Configuration File (INI Format)
; Generated by InHouse PBX System
; WARNING: ZIP 37G typically requires config.bin (TAR with INI files)
; This flat format may have limited compatibility
...
;;============================================================================
[ General ]
UserAgent = Zultys ZIP 37G - $FW_VER
...
AuthName = {{EXTENSION_NAME}}
password = {{EXTENSION_PASSWORD}}
SIPServerHost = {{SIP_SERVER}}
SIPServerPort = {{SIP_PORT}}
Expire = 600
Transport = 0
MissedCallLog = 0
AutoAnswer = 0
RejectAnonymousCall = 1
