...
class QoSMetrics:
    ...
    def _calculate_mos(self) -> None:
        ...
        if self.packets_received > 0:
            ...
            r_factor -= (loss_rate * 2.5)  # ~2.5 R-factor reduction per 1% loss
        ...
        if r_factor < 0:
            ...
            self.mos_score = 1 + 0.035 * r_factor + 0.000007 * r_factor * (r_factor - 60) * (100 - r_factor)
...
class QoSMonitor:
    ...
    def stop_monitoring(self, call_id: str) -> Optional[Dict]:
        ...
        with self.lock:
            ...
            self.logger.info(f"Stopped QoS monitoring for call {call_id}, MOS: {summary['mos_score']}")
    ...
    def get_statistics(self) -> Dict:
        ...
        with self.lock:
            ...
            calls_with_issues = sum(1 for d in self.historical_data 
                                   if d['mos_score'] < self.alert_thresholds['mos_min'])
