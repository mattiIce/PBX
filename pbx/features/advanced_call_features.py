...
class AdvancedCallFeatures:
    ...
    def __init__(self, config=None):
        ...
        self.enabled = self.config.get('features', {}).get('advanced_call_features', {}).get('enabled', False)
    ...
    def _load_supervisor_permissions(self):
        ...
        perms = self.config.get('features', {}).get('advanced_call_features', {}).get('supervisors', [])
        for perm in perms:
            self.supervisor_permissions[perm['supervisor_id']] = set(perm.get('monitored_extensions', []))
    ...
    def start_whisper(self, call_id: str, supervisor_id: str, agent_extension: str) -> Dict:
        ...
        self.logger.info(f"Supervisor {supervisor_id} started whisper on call {call_id} with {agent_extension}")
    ...
    def start_barge_in(self, call_id: str, supervisor_id: str, agent_extension: str) -> Dict:
        ...
        self.logger.info(f"Supervisor {supervisor_id} barged into call {call_id} with {agent_extension}")
    ...
    def start_monitor(self, call_id: str, supervisor_id: str, agent_extension: str) -> Dict:
        ...
        self.logger.info(f"Supervisor {supervisor_id} started monitoring call {call_id} with {agent_extension}")
