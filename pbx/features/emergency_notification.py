...
class EmergencyContact:
    ...
    def __init__(self, name: str, extension: str = None, phone: str = None, 
                 email: str = None, priority: int = 1, notification_methods: List[str] = None):
        """
...
class EmergencyNotificationSystem:
    ...
    def __init__(self, pbx_core, config: dict = None, database=None):
        ...
        self.notify_methods = self.config.get('features.emergency_notification.methods', ['call', 'page', 'email'])
        self.page_priority = self.config.get('features.emergency_notification.page_priority', 'emergency')
    ...
    def add_emergency_contact(self, name: str, extension: str = None, 
                            phone: str = None, email: str = None,
                            priority: int = 1, notification_methods: List[str] = None) -> EmergencyContact:
        """
