...
class TimeBasedRouting:
    ...
    def __init__(self, config=None):
        ...
        self.enabled = self.config.get('features', {}).get('time_based_routing', {}).get('enabled', False)
    ...
    def get_routing_destination(self, destination: str, call_time: Optional[datetime] = None) -> Dict:
        """
    ...
    def create_business_hours_rule(self, destination: str, route_to: str,
    ...
    def create_after_hours_rule(self, destination: str, route_to: str,
                               after_time: str = "17:00", before_time: str = "09:00") -> str:
        ...
        rule = {
            ...
            'time_conditions': {
                'time_range': {
                    'start': after_time,
                    'end': before_time  # Spans midnight
                }
            },
            'priority': 90
        }
