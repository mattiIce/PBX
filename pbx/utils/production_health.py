...
class ProductionHealthChecker:
        ...
        try:
            if not self.pbx_core:
                return False, {
                    ...
                    "message": "PBX core not available"
                }
            ...
            try:
                ...
                registered_extensions = len([e for e in self.pbx_core.extension_registry.get_all() if e.registered])
            except Exception:
                active_calls = 0
    ...
    def _check_system_resources(self) -> Tuple[bool, Dict[str, Any]]:
        ...
        try:
            ...
            is_ok = (
                cpu_percent < cpu_warning and
                memory.percent < memory_warning and
            ...
            if self.pbx_core:
                try:
                    ...
                    metrics["registered_extensions"] = len([
                        e for e in self.pbx_core.extension_registry.get_all()
                        if e.registered
                    ])
...
def format_health_check_response(is_healthy: bool, details: Dict[str, Any], 
                                 format_type: str = "json") -> Tuple[int, str]:
    """
