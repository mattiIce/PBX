...
def main():
    parser = argparse.ArgumentParser(
        description='Synchronize users from Active Directory to PBX'
    )
    parser.add_argument(
        '--dry-run',
        action='store_true',
    ...
    parser.add_argument(
        '--test-users',
        nargs='+',
        help='Only sync specific test users'
    )
    parser.add_argument(
        '--verbose',
        action='store_true',
    ...
    ad_config = {
        ...
        'integrations.active_directory.use_ssl': config.get('integrations.active_directory.use_ssl', True),
        'integrations.active_directory.auto_provision': config.get('integrations.active_directory.auto_provision'),
        'integrations.active_directory.user_search_base': config.get('integrations.active_directory.user_search_base'),
        'integrations.active_directory.deactivate_removed_users': config.get('integrations.active_directory.deactivate_removed_users', True),
