...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--hostname", default="localhost", help="Hostname for the certificate (default: localhost)"
    )
    parser.add_argument(
        "--days", type=int, default=365, help="Number of days certificate is valid (default: 365)"
    )
    parser.add_argument(
    ...
    try:
        generate_self_signed_cert(
            cert_dir=args.cert_dir, hostname=args.hostname, days_valid=args.days
        )
