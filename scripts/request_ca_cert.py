...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Request SSL certificate from in-house CA"
    )
    parser.add_argument(
        "--ca-server",
        help="URL of the CA server (e.g., https://ca.example.com)"
    )
    parser.add_argument(
        "--ca-endpoint",
    ...
    parser.add_argument(
        "--ca-cert",
        help="Path to CA certificate for verification (optional)"
    )
    parser.add_argument(
        "--config",
        default="config.yml",
