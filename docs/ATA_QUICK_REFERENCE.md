...
Or use Admin Panel → Phone Provisioning → Register New Device
...
✅ **Auto-Provisioning** - Zero-touch setup like IP phones
✅ **T.38 Fax** - Fax over IP support
✅ **Echo Cancellation** - Optimized for analog audio
✅ **DTMF Support** - Works with IVR/voicemail
✅ **Caller ID** - Display on analog phones
✅ **G.711 Codecs** - Best quality for analog
...
📖 **Complete Guide**: [docs/ATA_SUPPORT_GUIDE.md](ATA_SUPPORT_GUIDE.md) - Comprehensive setup and troubleshooting

📖 **Phone Provisioning**: [PHONE_PROVISIONING.md](../PHONE_PROVISIONING.md) - General provisioning guide

📖 **Features**: [FEATURES.md](../FEATURES.md) - All PBX features
...
1. ✅ Use dedicated extension for fax machines
2. ✅ Label physical devices with extension numbers
3. ✅ Change default ATA admin passwords
4. ✅ Test thoroughly before production deployment
5. ✅ Keep ATA firmware updated
6. ✅ Monitor call quality with QoS metrics
...
- 📝 Documentation: [docs/ATA_SUPPORT_GUIDE.md](ATA_SUPPORT_GUIDE.md)
