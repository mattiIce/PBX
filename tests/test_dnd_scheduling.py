...
from pbx.features.dnd_scheduling import DNDRule, DNDScheduler, CalendarMonitor
from pbx.features.presence import PresenceSystem, PresenceStatus
...
def test_time_based_rule():
    ...
    # Test wrong day
    test_time = datetime(2025, 12, 9, 10, 0)  # Tuesday 10:00 AM (not in days list)
