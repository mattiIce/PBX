...
from pbx.utils.dtmf import DTMFDetector, DTMFGenerator, DTMF_FREQUENCIES
...
class TestDTMFDetection(unittest.TestCase):
    ...
    def test_no_detection_on_weak_tone(self):
        ...
        # Generate a very weak DTMF tone (amplitude 0.005, below 0.01 threshold)
        ...
        # Detector should NOT detect such a weak tone (below 0.01 energy threshold)
        digit = self.detector.detect_tone(samples)
    ...
    def test_threshold_parameter(self):
        ...
        # the Goertzel algorithm produces high magnitudes for matching frequencies
    ...
    def test_noise_rejection_ratio(self):
        ...
        digit = self.detector.detect_tone(samples)
        self.assertEqual(digit, '1', "DTMF tone should be detected when dominant over noise")
