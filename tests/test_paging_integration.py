...
def test_paging_extension_detection():
    ...
    assert paging.is_paging_extension(
        '1001') == False, "1001 should not be paging extension"
    assert paging.is_paging_extension(
        '8001') == False, "8001 should not be paging extension"
...
def test_paging_disabled():
    ...
    assert paging.is_paging_extension(
        '700') == False, "Should not detect paging extensions"
    assert paging.initiate_page(
        '1001', '700') is None, "Should not initiate page"
