...
def test_verbose_logging_enabled():
    ...
    assert signaling.enabled == True, "Should be enabled"
    assert signaling.verbose_logging == True, "Verbose logging should be enabled"
...
def test_gateway_verbose_logging():
    ...
    assert gateway.verbose_logging == True, "Gateway should have verbose logging enabled"
