...
def test_emergency_contacts_table_creation():
    ...
    try:
        ...
        cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='emergency_contacts'")
        ...
        required_columns = ['id', 'name', 'extension', 'phone', 'email', 'priority', 'notification_methods', 'active']
...
def test_emergency_notifications_table_creation():
    ...
    try:
        ...
        cursor = db.connection.cursor()
        cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='emergency_notifications'")
        result = cursor.fetchone()
        ...
        required_columns = ['id', 'timestamp', 'trigger_type', 'details', 'contacts_notified', 'methods_used']
        for col in required_columns:
